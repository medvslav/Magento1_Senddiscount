...
/**
 * Senddiscount Email processor
 *
 * @category   Medvslav
 * @package    Medvslav_Senddiscount
 * @author     Medved Yaroslav
 */
class Medvslav_Senddiscount_Model_Email extends Mage_Core_Model_Abstract
{
    ...
    public function send()
    {
        ...
        if ($this->_type == 'price') {
            $this->_getPriceBlock()
                ->setStore($store)
                ->reset();
            $this->_getPriceBlock()->setEmail(urlencode($this->_customer->getEmail()));
            foreach ($this->_priceProducts as $product) {
                if($this->_customer->getGroupId()){
        ...
        Mage::getModel('core/email_template')
            ->setDesignConfig(array(
                ...
                ($this->_customer->getName())?$this->_customer->getName():$this->_customer->getFirstName(),
                array(
                    'customerName'  => ($this->_customer->getName())?$this->_customer->getName():$this->_customer->getFirstName(),
